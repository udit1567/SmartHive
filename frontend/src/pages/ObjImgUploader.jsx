...
const ObjImgUploader = () => {
  ...
  const handleConfirmUpload = async () => {  
    ...
    try {
      ...
      setResponseMessage(data.message || "Object detection completed.");
      ...
      setResponseMessage("Error detecting Objects. Try again.");
    } finally {
      setTempImage(null);
      setFile(null); 
      setLoading(false);
  ...
  return (
    <Card>
      <CardContent>
        <Typography variant="h6">Upload Object Image</Typography>
        <Box
          sx={{
