...
const ObjImgPreview = ({ apiUrl }) => {
  ...
  useEffect(() => {
    ...
    fetch(apiUrl, {
      ...
      .then((data) => {
        if (data.object_detection_images) {
          setImages(data.object_detection_images); // Reverse the order of images
        } else {
